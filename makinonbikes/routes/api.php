...
Route::middleware('auth:sanctum')->put('/editarCita', [CitaTallerController::class, 'editarCita']);
...
Route::middleware('auth:sanctum')->get('/obtenerCitaId/{id}', [CitaTallerController::class, 'obtenerCitaId']);
