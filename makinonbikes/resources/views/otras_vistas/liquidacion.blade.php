...
@section('main')
    <div id="contenedorNuevosProductos">
        ...
        <h2 class="mt-0 mb-4 text-left">Productos en liquidación</h2>
        <p>Lamentamos decirle que actualmento no tenemos ningún producto en liquidación.</p>
        <hr>
            ...
            @for ($i = 0; $i < 4; $i++)
                <div class="card m-2 hover-card shadow-sm" style="flex: 0 0 auto; padding:20px">
                    <a style="color:black; text-decoration:none;">
                        ...
                        <img src="{{ asset('./images/dibujo_bici.png') }}" class="card-img-top img-fluid"
