            ...
            <div class="formulario-contacto">
                ...
                <form action="{{ route('contacto') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <x-text-input type="text" name="nombre" id="nombre" class="form-control"
                            required></x-text-input>
                    </div>
                    <div class="form-group">
                        <x-input-label for="email">Email</x-input-label>
                        <x-text-input type="email" name="email" id="email" class="form-control"
                            required></x-text-input>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <x-textarea-input type="text" name="mensaje" id="mensaje" class="form-control"
