        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="mt-4">
                    ...
                    <input type="text" class="form-control" id="nif" name="nif" value="{{ $usuario->nif }}">
            ...
            <div class="col-md-6">
                ...
                <div class="mt-4">
                    ...
                    <input type="text" class="form-control" id="cp" name="cp" value="{{ $usuario->cp }}">
            ...
            <div class="d-flex justify-content-center mt-5">
                <x-makinon-primary-button type="submit" style="margin-right:10px">@lang('makinon.guardar')</x-makinon-primary-button>
