                    ...
                    @foreach ($usuarios as $usuario)
                        <tr>
                            ...
                            <td style="text-align:center">
                                <a href="{{ route('fichaUsuarioAdmin', $usuario->id_usuario) }}"
                                    aria-label="Ficha del usuario"><i class="fa-regular fa-file"></i></a>
                            </td>
                            <td style="text-align:center">
                                <a href="{{ route('modificarUsuarioAdmin', $usuario->id_usuario) }}"
                                    aria-label="Modificar al usuario"><i class="fa-regular fa-edit"></i></a>
                            </td>
                            <td style="text-align:center">
