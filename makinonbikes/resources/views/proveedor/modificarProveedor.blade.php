...
@section('main')
    <!-- Muestra la vista del formulario para modificar un proveedor junto con sus datos -->
    <div class="card w-50">
        ...
        <form method="POST" action="{{ route('eliminarProveedor', $proveedor->id_proveedor) }}">
            ...
            @method('DELETE')
            <x-makinon-primary-button type="submit"
                style="margin-left:16px; margin-bottom:10px; width:25%">@lang('makinon.elimProv')</x-makinon-primary-button>

        </form>
        <div>
            <x-makinon-primary-link-button href="{{ route('listadoProveedores') }}"
